...
class BSBattleViewController: UIViewController {
    
    var skView: SKView!
    var gameHud: BSGameHUD!
    var gameScene: BSBattleScene!
    ...
    override func viewDidLoad() {
        ...
        gameScene = BSBattleScene.init(size: CGSize(width: sceneWidth, height: sceneHeight))
        ...
        gameCamera = BSBattleCamera(view: skView, scene: gameScene)
