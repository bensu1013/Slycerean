...
struct BSTilePlotter {
    ...
    static func getValidWalkingTiles(onGameBoard board: BSGameBoard, forUnit unit: BSBattleUnit) -> [TileCoord] {
    ...
    static func getValidAttackingTiles(onGameBoard board: BSGameBoard, forUnit unit: BSBattleUnit) -> [TileCoord] {
    ...
    static func getValidCrossPatternTiles(onGameBoard board: BSGameBoard,
                                   withRange range: Int,
    ...
    static func getValidDiamondPatternTiles(onGameBoard board: BSGameBoard,
                                          withRange range: Int,
                                          atTileCoord tileCoord: TileCoord) -> [TileCoord] {
        var patternTiles = [tileCoord]
        var top = tileCoord.top
    ...
    static func getValidSquarePatternTiles(onGameBoard board: BSGameBoard,
                                          withRange range: Int,
                                          atTileCoord tileCoord: TileCoord) -> [TileCoord] {
